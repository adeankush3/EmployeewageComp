...
empDailyWageMap.set(total_workingDays,calDailyWage(emphr));
console.log("Employee Daily Wage using Map :"+Array.from(empDailyWageMap.values()).reduce(TotalWages,0));